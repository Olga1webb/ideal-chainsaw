...
Количество блоков (октетов в Unicode) изменяется в зависимости от порядкового номера символа, что позволяет работать с данными без лишних затрат памяти. Такой вид кодирования совместим с 7-битным кодированием текста ASCII. То есть при работе с латиницей, большинство букв, цифр и знаков пунктуации будут кодироваться **лишь одним байтом.** Такое рациональное использование памяти при работе с традиционным набором символов Основной многоязычной плоскости Unicode является одним из ключевых преимуществ UTF-8 перед рассматриваемой далее кодировкой UTF-16.
